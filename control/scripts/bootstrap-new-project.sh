...
usage() {
  cat <<'USAGE'
Usage:
  bash control/scripts/bootstrap-new-project.sh --project-dir /path/to/project [options]
...
if [[ -x "$PROJECT_DIR/.ai-control/control/scripts/agent-check.sh" ]]; then
  "$PROJECT_DIR/.ai-control/control/scripts/agent-check.sh"
fi

if [[ -x "$PROJECT_DIR/.ai-control/control/scripts/docs-link-check.sh" ]]; then
  "$PROJECT_DIR/.ai-control/control/scripts/docs-link-check.sh"
fi

if [[ -x "$PROJECT_DIR/.ai-control/control/scripts/check-project-ready.sh" ]]; then
  "$PROJECT_DIR/.ai-control/control/scripts/check-project-ready.sh" || true
fi
