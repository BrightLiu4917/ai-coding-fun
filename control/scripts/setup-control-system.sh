...
if [[ -x "$PROJECT_DIR/.ai-control/control/scripts/docs-link-check.sh" ]]; then
  "$PROJECT_DIR/.ai-control/control/scripts/docs-link-check.sh" && step "docs-link-check 通过" || warn "docs-link-check 有警告"
fi

if [[ -x "$PROJECT_DIR/.ai-control/control/scripts/check-project-ready.sh" ]]; then
  "$PROJECT_DIR/.ai-control/control/scripts/check-project-ready.sh" && step "check-project-ready 通过" || warn "check-project-ready 有警告"
fi
...
echo "  ─────────────────────────────────────────"
echo "  - 小白初始化项目卡片："
echo "     bash .ai-control/control/scripts/ai-dev.sh init"
echo ""
...
echo "     bash .ai-control/control/scripts/ai-dev.sh feature add-my-feature"
echo ""
...
echo "  ─────────────────────────────────────────"
echo "  bash .ai-control/control/scripts/agent-check.sh                     # 校验 agent 结构"
echo "  bash .ai-control/control/scripts/ai-dev.sh next                     # 查看下一步建议"
echo "  bash .ai-control/control/scripts/openspec-check.sh <change-dir>     # 校验 OpenSpec change"
echo "  bash .ai-control/control/scripts/run-tests.sh                       # 统一测试入口"
echo "  bash .ai-control/control/scripts/openspec-conflict-check.sh         # 多 change 冲突检测"
echo "  bash .ai-control/control/scripts/check-project-ready.sh             # 检查项目接入完整性"
echo ""
