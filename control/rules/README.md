...
单层编号目录，给 AI 按需读取的工程规则。编号即分类：

- 00-09 基线：00-agent-base（角色骨架）、01-code-change（精准修改/精简/清理）、02-business、03-product、04-ux、05-ui-design
...
约定：规则内容只在本目录维护；agent 手册通过"必须读取"引用，不复述正文。
