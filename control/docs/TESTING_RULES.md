...
```bash
PROJECT_TEST_COMMAND='mvn test -DskipITs=false' bash .ai-control/control/scripts/run-tests.sh
```
...
```bash
bash .ai-control/control/scripts/summarize-log.sh .agent/logs/test.log
```
