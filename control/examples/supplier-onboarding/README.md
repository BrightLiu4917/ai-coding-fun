...
```bash
bash control/scripts/openspec-check.sh control/examples/supplier-onboarding/openspec/changes/add-supplier-onboarding
bash control/scripts/route-compliance-check.sh control/examples/supplier-onboarding/openspec/changes/add-supplier-onboarding
```
