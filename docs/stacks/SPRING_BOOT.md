...
本文件是 Spring Boot 技术栈入口规则；详细实现约束以 `docs/SPRING_BOOT_RULES.md` 为准。

读取顺序：

1. 先读 `docs/stacks/SPRING_BOOT.md` 判断是否适用。
2. 再读 `docs/SPRING_BOOT_RULES.md` 获取依赖分级、ID、异常、事务和 DTO/VO 细则。
